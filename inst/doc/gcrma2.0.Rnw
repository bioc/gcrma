...
%\VignetteDepends{affy,matchprobes,tools,hgu95av2probe,hgu95v2acdf,splines}
...
We have improved the speed of  the function and therefore changed the default 
setting in function \Rfunction{gcrma} from \Rfunarg{fast=TRUE} to \Rfunarg{fast=FALSE}.
